...
import { KnowledgeBaseCurriculumSection } from '../types';
...
const Curriculum: React.FC = () => {
    const [activeL3Section, setActiveL3Section] = useState<KnowledgeBaseCurriculumSection>('Browse');
