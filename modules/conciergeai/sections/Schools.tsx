...
import { ConciergeAISchoolsSection } from '../types';
...
const Schools: React.FC = () => {
    const [activeL3Section, setActiveL3Section] = useState<ConciergeAISchoolsSection>('Manage Schools');
