...
import { ConciergeAISystemPromptsSection } from '../types';
...
const SystemPrompts: React.FC = () => {
    const [activeL3Section, setActiveL3Section] = useState<ConciergeAISystemPromptsSection>('Prompt Library');
    ...
    return (
        <div className="flex h-full">
            <ConciergeAIL3Sidebar 
                activeL2Section="System Prompts" 
